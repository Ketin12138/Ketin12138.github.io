...
- **[2026-09]** My paper about Semi-supervised Contrastive Learning Depth Estimation is accepted to <strong>Pattern Recognition</strong>(IF: 9.1).
- **[2025-07]** My paper about Machine Learning for Sports Outcome Prediction is accepted to <strong>Scientific Reports</strong>(IF: 4.9).
